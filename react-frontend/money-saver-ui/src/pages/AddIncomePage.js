        ...
        <Form.Row className="pt-2">
          <Form.Group as={Col} sm={4}>
            <Form.Group as={Col} sm={10}>
              <Form.Control
                placeholder={this.props.t("amount_prompt")}
                id="amount"
            ...
            <Form.Group as={Col} sm={10}>
              ...
              >
                {Object.keys(this.props.currencies).map((key) => (
                  <option key={key}>{this.props.currencies[key]}</option>
                ))}
              </Form.Control>
            </Form.Group>
            <Form.Group as={Col} sm={10}>
              <Form.Control
                ...
                onChange={this.handleOnChange}
              >
                {Object.keys(this.props.frequencies).map((key) => (
                  <option key={key}>{this.props.frequencies[key]}</option>
                ))}
              </Form.Control>
            </Form.Group>
            <Form.Group as={Col} sm={10}>
              <Form.Control
                ...
                onChange={this.handleOnChange}
              >
                {Object.keys(this.props.incomeCategories).map((key) => (
                  <option key={key}>{this.props.incomeCategories[key]}</option>
                ))}
              </Form.Control>
            </Form.Group>
            <Form.Group as={Col} sm={10}>
              <Form.Control
                as="textarea"
                rows="3"
                placeholder={this.props.t("note_prompt")}
                id="note"
                onChange={this.handleOnChange}
              />
            </Form.Group>
          ...
          <Form.Group as={Col} sm={6} className="d-flex flex-column">
            ...
            <DatePicker
              ...
              selected={this.state.dateOfIncome}
