...
public class FinanceServiceIntegrationTest {
    ...
    public void shouldReturnDropdownValuesForPolishLang() {
        ...
        var expectedResult = FinanceDropdownValuesDTO.builder()
                ...
                .build();
        //when
        FinanceDropdownValuesDTO financeDropdownValuesDTO = financeService.getDropdownValues();
        //then
        assertThat(financeDropdownValuesDTO, equalTo(expectedResult));
    }
    ...
    public void shouldDeleteIncome() {
        ...
        //when
        financeService.deleteFinance(FinanceType.INCOME, incomeUuid);
        //then
